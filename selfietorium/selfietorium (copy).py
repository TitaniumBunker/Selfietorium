...
# Screen methods
    ...
    def preen_screen(self, photoshoot, svg_data, preentime=10):
        ...
        try:
            ...
            print ("SCREEN WIDTH = " + str(float(screenGeometry[0])))
            print ("SCREEN HEIGHT= " + str(float(screenGeometry[1])))
            ...
            print ("PICAM WIDTH = " + str(pcamWidth))
            print ("PICAM HEIGHT = " + str(pcamHeight))
            print ("PICAM X = " + str(picamx))
            print ("PICAM Y = " + str(picamy))
	    print ("PICAM X2= " + str(picamx + pcamWidth))
	    print ("PICAM Y2= " + str(picamy + pcamHeight))
	    ...
	    #raise ValueError('A very specific bad thing happened')
            ...
            for shot in photoshoot:
                ...
                while preentime - preentimeSpent > 0:
                    ...
                    photo = self.mymethod.GetPhoto(cam)
	...
	print (my_font)
        print (str(my_rect))
        print (str(self.ERROR_FONT_COLOUR))
        ...
        screenElements.append(ScreenElelement(IMG,0,0))
        screenElements.append(ScreenElelement(prompt,promptx, prompty))
        self.show_screen_elements(screenElements,3)
        print ('Error :')
